...
class Package(BaseModel):
    ...
    org = models.ForeignKey(
        verbose_name="组织", to=Organization, on_delete=models.SET_NULL, db_constraint=False, db_index=True
    )
...
class GenericIP(BaseModel):
    ...
    ip_type = models.CharField(verbose_name="IP类型", db_index=True, choices=asset.IPType.choices)
    org = models.ForeignKey(
        verbose_name="组织", to=Organization, on_delete=models.SET_NULL, db_constraint=False, db_index=True
    )
